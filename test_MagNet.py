...
from MagNet.defensive_models import DefensiveModel1
...
class DirectTrainActorReconstruct:
    def __init__(
        ...
        self.defensemodel = DefensiveModel1(in_channels=1).to(self.device)
        self.save_path = os.path.join(get_project_path(project_name="Defense"), "pretrained", "magnet.pth")
        self.defensemodel.load_state_dict((torch.load(self.save_path)))
